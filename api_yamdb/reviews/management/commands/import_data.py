...
from reviews.models import User, Category, Genre, Title, TitleGenre, Review, \
    Comment
...
# FILE_DCT = {
#     (STATIC_DATA + r'\category.csv'): Category,
#     (STATIC_DATA + r'\genre.csv'): Genre,
#     (STATIC_DATA + r'\users.csv'): User,
#     (STATIC_DATA + r'\titles.csv'): Title,
#     (STATIC_DATA + r'\genre_title.csv'): TitleGenre,
#     (STATIC_DATA + r'\review.csv'): Review,
#     (STATIC_DATA + r'\comments.csv'): Comment,
# }
#
# for key, value in FILE_DCT.items():
#     print(f'РљР»СЋС‡: { key } Рё РµРіРѕ Р·РЅР°С‡РµРЅРёРµ: { value }!')
